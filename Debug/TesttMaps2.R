...
library(sf)
library(leaflet)
if ("rnaturalearth" %in% rownames(installed.packages()) == FALSE) (install.packages("rnaturalearth")); library("rnaturalearth");
if ("rnaturalearthdata" %in% rownames(installed.packages()) == FALSE) (install.packages("rnaturalearthdata")); library("rnaturalearthdata");
